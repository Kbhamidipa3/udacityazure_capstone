...
resource_group = 'aml-quickstarts-132176'
workspace_name = 'quick-starts-ws-132176'
...
def clean_data(data):
    ...
    x_df.to_csv("LV_github_automl.csv")    
    ...
    x_df.to_csv("LV_github_hypertune.csv")   
    # Separate out the label data from the remainder of the dataframe
    y_df = x_df.pop("Score").astype(int)
    x_df.to_csv("LV_github_data.csv") 
    y_df.to_csv("LV_github_label.csv") 
